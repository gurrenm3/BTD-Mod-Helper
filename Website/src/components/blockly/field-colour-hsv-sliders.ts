...
export class FieldColourHsvSliders extends FieldColour {
  ...
  private createDropdownSliders(): void {
    ...
    this.alphaReadout = FieldColourHsvSliders.createLabelInContainer(
      "Alpha",
      container
    );
  ...
  private onSliderChange(event?: Event): void {
    ...
    const brightness: number =
      ...
      FieldColourHsvSliders.BRIGHTNESS_SLIDER_MAX;
    const alpha: number =
      parseFloat(this.alphaSlider.value) /
      FieldColourHsvSliders.ALPHA_SLIDER_MAX;
    this.setValue(
      FieldColourHsvSliders.hsvToHex(hue, saturation, brightness, alpha)
    );
    this.renderSliders();
  }
  ...
  private renderSliders(): void {
    ...
    hueGradient +=
      FieldColourHsvSliders.hsvToHex(0 / 6, s, v, a) +
    ...
    hueGradient +=
      FieldColourHsvSliders.hsvToHex(6 / 6, s, v, a) +
    ...
    saturationGradient +=
      FieldColourHsvSliders.hsvToHex(h, 0, v, a) +
      ` ${FieldColourHsvSliders.THUMB_RADIUS}px, `;
    saturationGradient +=
      FieldColourHsvSliders.hsvToHex(h, 1, v, a) +
      ` calc(100% - ${FieldColourHsvSliders.THUMB_RADIUS}px))`;
    ...
    brightnessGradient +=
      FieldColourHsvSliders.hsvToHex(h, s, 0, a) +
      ` ${FieldColourHsvSliders.THUMB_RADIUS}px, `;
    brightnessGradient +=
      FieldColourHsvSliders.hsvToHex(h, s, 1, a) +
      ` calc(100% - ${FieldColourHsvSliders.THUMB_RADIUS}px))`;
    ...
    alphaGradient +=
      FieldColourHsvSliders.hsvToHex(h, s, v, 0) +
      ` ${FieldColourHsvSliders.THUMB_RADIUS}px, `;
    alphaGradient +=
      FieldColourHsvSliders.hsvToHex(h, s, v, 1) +
      ` calc(100% - ${FieldColourHsvSliders.THUMB_RADIUS}px))`;
  ...
  private updateSliderValues(): void {
    ...
    this.alphaSlider.value = String(
      hsv.a * FieldColourHsvSliders.ALPHA_SLIDER_MAX
    );
