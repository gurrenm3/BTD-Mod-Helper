...
public static partial class InputFieldExt
{
    ...
    /// </summary>
    public static void AddOnValueChangeEvent(this InputField inputField,
        InputFieldOnValueChanged.Function funcToExecute)
    {
    ...
    /// </summary>
    public static void AddOnValueChangedEvent(this InputField inputField,
        InputFieldOnValueChanged.Function funcToExecute)
    {
