...
public static class UpgradeModelExt
{
    ...
    {
        return Game.instance.model.GetUpgrade(upgradePathModel.upgrade);
    }
    ...
    {
        return ModUpgrade.Cache.TryGetValue(upgradePathModel.upgrade, out var modUpgrade) ? modUpgrade : null;
    }
}