...
public static class BloonModelBehaviorExt
{
    ...
    /// <returns></returns>
    public static bool HasBehavior<T>(this BloonModel model) where T : Model => ModelBehaviorExt.HasBehavior<T>(model);
    ...
    /// <param name="model"></param>
    /// <returns></returns>
    public static T GetBehavior<T>(this BloonModel model) where T : Model => ModelBehaviorExt.GetBehavior<T>(model);
