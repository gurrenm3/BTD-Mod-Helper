...
/// <summary>
/// Extensions for BoostArtifactModels
/// </summary>
public static partial class ArtifactModelBehaviorExt
{
    ...
    public static bool HasBehavior<T>(this BoostArtifactModel model) where T : Model => 
    ...
    public static bool HasBehavior<T>(this BoostArtifactModel model, string nameContains) where T : Model =>
    ...
    public static bool HasBehavior<T>(this BoostArtifactModel model, [NotNullWhen(true)] out T behavior) where T : Model =>
        ModelBehaviorExt.HasBehavior<T>(model, out behavior);
        
    /// <inheritdoc cref="ModelBehaviorExt.HasBehavior{T}(Il2CppAssets.Scripts.Models.Model,string,out T)" />
    public static bool HasBehavior<T>(this BoostArtifactModel model, string nameContains, [NotNullWhen(true)] out T behavior) where T : Model =>
    ...
    public static T GetBehavior<T>(this BoostArtifactModel model) where T : Model => 
        ModelBehaviorExt.GetBehavior<T>(model);

    /// <inheritdoc cref="ModelBehaviorExt.GetBehavior{T}(Il2CppAssets.Scripts.Models.Model,int)" />
    public static T GetBehavior<T>(this BoostArtifactModel model, int index) where T : Model =>
    ...
    public static T GetBehavior<T>(this BoostArtifactModel model, string nameContains) where T : Model =>
        ModelBehaviorExt.GetBehavior<T>(model, nameContains);

    /// <inheritdoc cref="ModelBehaviorExt.GetBehaviors{T}" />
    public static List<T> GetBehaviors<T>(this BoostArtifactModel model) where T : Model =>
    ...
    public static void AddBehavior<T>(this BoostArtifactModel model, T behavior) where T : Model => 
    ...
    public static void RemoveBehavior<T>(this BoostArtifactModel model) where T : Model => 
        ModelBehaviorExt.RemoveBehavior<T>(model);

    /// <inheritdoc cref="ModelBehaviorExt.RemoveBehavior" />
    public static void RemoveBehavior<T>(this BoostArtifactModel model, T behavior) where T : Model => 
    ...
    public static void RemoveBehavior<T>(this BoostArtifactModel model, int index) where T : Model =>
    ...
    public static void RemoveBehavior<T>(this BoostArtifactModel model, string nameContains) where T : Model =>
        ModelBehaviorExt.RemoveBehavior<T>(model, nameContains);
    
    /// <inheritdoc cref="ModelBehaviorExt.RemoveBehaviors{T}" />
    public static void RemoveBehaviors<T>(this BoostArtifactModel model) where T : Model => 
    ...
    public static void AddBehavior(this BoostArtifactModel model, ModelHelper behavior) => 
        ModelBehaviorExt.AddBehavior(model, behavior);
}