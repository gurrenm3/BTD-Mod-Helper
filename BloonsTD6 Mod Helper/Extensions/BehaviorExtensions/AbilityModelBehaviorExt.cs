...
/// </summary>
public static partial class AbilityModelBehaviorExt
{
    ...
    public static bool HasBehavior<T>(this AbilityModel model, string nameContains) where T : Model =>
    ...
    public static bool HasBehavior<T>(this AbilityModel model, [NotNullWhen(true)] out T behavior) where T : Model =>
        ModelBehaviorExt.HasBehavior<T>(model, out behavior);
        
    /// <inheritdoc cref="ModelBehaviorExt.HasBehavior{T}(Il2CppAssets.Scripts.Models.Model,string,out T)" />
    public static bool HasBehavior<T>(this AbilityModel model, string nameContains, [NotNullWhen(true)] out T behavior) where T : Model =>
    ...
    public static T GetBehavior<T>(this AbilityModel model, int index) where T : Model =>
    ...
    public static T GetBehavior<T>(this AbilityModel model, string nameContains) where T : Model =>
    ...
    public static void RemoveBehavior<T>(this AbilityModel model, int index) where T : Model =>
    ...
    public static void RemoveBehavior<T>(this AbilityModel model, string nameContains) where T : Model =>
    ...
    public static void AddBehavior(this AbilityModel model, ModelHelper behavior) => 
        ModelBehaviorExt.AddBehavior(model, behavior);
}