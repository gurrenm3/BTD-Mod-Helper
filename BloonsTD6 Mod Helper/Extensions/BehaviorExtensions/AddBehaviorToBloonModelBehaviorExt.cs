...
/// </summary>
public static partial class AddBehaviorToBloonModelBehaviorExt
{
    ...
    public static bool HasBehavior<T>(this AddBehaviorToBloonModel model, string nameContains) where T : Model =>
    ...
    public static bool HasBehavior<T>(this AddBehaviorToBloonModel model, [NotNullWhen(true)] out T behavior) where T : Model =>
        ModelBehaviorExt.HasBehavior<T>(model, out behavior);
        
    /// <inheritdoc cref="ModelBehaviorExt.HasBehavior{T}(Il2CppAssets.Scripts.Models.Model,string,out T)" />
    public static bool HasBehavior<T>(this AddBehaviorToBloonModel model, string nameContains, [NotNullWhen(true)] out T behavior) where T : Model =>
    ...
    public static void AddBehavior<T>(this AddBehaviorToBloonModel model, T behavior) where T : Model => 
    ...
    public static void RemoveBehavior<T>(this AddBehaviorToBloonModel model, int index) where T : Model =>
    ...
    public static void RemoveBehavior<T>(this AddBehaviorToBloonModel model, string nameContains) where T : Model =>
