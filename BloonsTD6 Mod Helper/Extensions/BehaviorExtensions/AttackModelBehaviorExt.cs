...
/// </summary>
public static partial class AttackModelBehaviorExt
{
    ...
    public static bool HasBehavior<T>(this AttackModel model, string nameContains) where T : Model =>
    ...
    public static bool HasBehavior<T>(this AttackModel model, [NotNullWhen(true)] out T behavior) where T : Model =>
        ModelBehaviorExt.HasBehavior<T>(model, out behavior);
        
    /// <inheritdoc cref="ModelBehaviorExt.HasBehavior{T}(Il2CppAssets.Scripts.Models.Model,string,out T)" />
    public static bool HasBehavior<T>(this AttackModel model, string nameContains, [NotNullWhen(true)] out T behavior) where T : Model =>
    ...
    public static T GetBehavior<T>(this AttackModel model, int index) where T : Model =>
    ...
    public static T GetBehavior<T>(this AttackModel model, string nameContains) where T : Model =>
    ...
    public static void RemoveBehavior<T>(this AttackModel model, int index) where T : Model =>
    ...
    public static void RemoveBehavior<T>(this AttackModel model, string nameContains) where T : Model =>
    ...
    public static void AddBehavior(this AttackModel model, ModelHelper behavior) => 
        ModelBehaviorExt.AddBehavior(model, behavior);
}