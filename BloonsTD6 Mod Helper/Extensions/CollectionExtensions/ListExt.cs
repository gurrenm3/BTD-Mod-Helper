...
public static partial class ListExt
{
    ...
    /// <param name="list"></param>
    /// <returns></returns>
    public static System.Collections.Generic.List<TCast> DuplicateAs<TSource, TCast>(
        this System.Collections.Generic.List<TSource> list)
    ...
    /// <param name="list"></param>
    /// <returns></returns>
    public static System.Collections.Generic.List<TCast> GetItemsOfType<TSource, TCast>(
        this System.Collections.Generic.List<TSource> list)
        where TSource : Object
        where TCast : Object
    {
    ...
    /// <param name="list"></param>
    /// <returns></returns>
    public static System.Collections.Generic.List<TSource> RemoveItemOfType<TSource, TCast>(
        this System.Collections.Generic.List<TSource> list)
        where TSource : Object
        where TCast : Object
    {
    ...
    /// <returns></returns>
    public static System.Collections.Generic.List<TSource> RemoveItem<TSource, TCast>(
        this System.Collections.Generic.List<TSource> list, TCast itemToRemove)
        where TSource : Object where TCast : Object
    {
        if (!HasItemsOfType<TSource, TCast>(list))
            return list;
    ...
    /// <param name="list"></param>
    /// <returns></returns>
    public static System.Collections.Generic.List<TSource> RemoveItemsOfType<TSource, TCast>(
        this System.Collections.Generic.List<TSource> list)
        where TSource : Object
        where TCast : Object
    {
