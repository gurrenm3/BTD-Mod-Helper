...
public static class IEnumerableExt
{
    ...
    /// <returns></returns>
    public static System.Collections.Generic.IEnumerable<TCast> CastAll<TSource, TCast>(
        this System.Collections.Generic.IEnumerable<TSource> list)
    ...
    /// </summary>
    public static T ArgMax<T, K>(this System.Collections.Generic.IEnumerable<T> source, System.Func<T, K> map = null,
        System.Collections.Generic.IComparer<K> comparer = null)
    {
    ...
    public static void Deconstruct<K, V>(this IGrouping<K, V> grouping, out K k,
        out System.Collections.Generic.List<V> v)
    {
        k = grouping.Key;
        v = grouping.ToList();
    }
    ...
    /// </summary>
    public static System.Collections.Generic.IEnumerable<T> Repeat<T>(
        this System.Collections.Generic.IEnumerable<T> enumerable, int n)
    {
