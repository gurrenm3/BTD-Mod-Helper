...
namespace BTD_Mod_Helper.Patches
{
    ...
    internal class InputManager_PrimeTower
    {
        ...
        internal static void Postfix(InputManager __instance)
        {
            ...
            TaskScheduler.ScheduleTask(() => { MelonMain.DoPatchMethods(mod => mod.OnTowerGraphicsCreated(__instance, __instance.placementModel, __instance.placementGraphics)); }, waitCondition: () =>
