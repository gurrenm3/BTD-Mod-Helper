...
public readonly struct Info
{
    ...
    /// <param name="width">
    /// The sizeDelta x field. This technically is how much the width should change compared to
    ...
    /// <param name="pivot">
    /// The point between (0, 0) and (1, 1) that this object rotates around and expands out from, by
    /// default (0.5, 0.5)
    /// </param>
