...
public class ModHelperComponent : MonoBehaviour
{
    ...
    {
        return AddInputField(info, defaultValue, background, onValueChanged, fontSize, validation,
    ...
    {
        return AddInputField(info, defaultValue, background, onValueChanged, fontSize, validation, align, placeholder,
            0);
    }
