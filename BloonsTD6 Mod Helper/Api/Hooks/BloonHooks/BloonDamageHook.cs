...
public class BloonDamageHook : ModHook<BloonDamageDelegate, BloonDamageManagedDelegate>
{
    ...
    public delegate bool BloonDamageManagedDelegate(ref Bloon @this, ref float totalAmount, ref Projectile projectile,
        ...
        ref bool canDestroyProjectile, ref bool ignoreNonTargetable, ref bool blockSpawnChildren, ref bool ignoreInvunerable,
        ...
        byte blockSpawnChildren, byte ignoreInvunerable, HookNullable<int> powerActivatedByPlayerId, nint methodInfo)
    {
        ...
        foreach (var (_, value) in PrefixList.OrderByDescending(prefix => prefix.Key))
        {
            ...
            {
                stopEarly |= !bloonDamageManagedDelegate(ref bloonValue, ref totalAmount, ref projectileValue,
                    ref distributeToChildrenBool,
        ...
        _ = CallOriginalMethod(bloonValue?.Pointer, totalAmount, projectileValue?.Pointer,
            GetBoolValue(distributeToChildrenBool), GetBoolValue(overrideDistributeBlockerBool),
            GetBoolValue(createEffectBool), towerValue?.Pointer, (int) immuneBloonPropertiesFlags,
            (int) originalImmuneBloonPropertiesFlags, GetBoolValue(canDestroyProjectileBool),
            GetBoolValue(ignoreNonTargetableBool), GetBoolValue(blockSpawnChildrenBool), GetBoolValue(ignoreInvunerableBool),
