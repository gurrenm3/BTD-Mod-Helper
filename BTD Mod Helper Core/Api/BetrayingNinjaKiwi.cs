namespace BTD_Mod_Helper.Api
{
    ...
    /// You forced our hand :(
    /// </summary>
    public class BetrayingNinjaKiwi
    {
        /// <summary>
        ...
        /// </summary>
        internal static void StartBypassingCheck() => CurrentlyBypassingCheck = true;

        /// <summary>
        /// Called in postfix patches on methods where we think modded clients should be accepted
        /// </summary>
        internal static void StopBypassingCheck() => CurrentlyBypassingCheck = DefaultBypassCheck;
    }
}