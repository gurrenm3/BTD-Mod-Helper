...
## ModGameModeTest<T> Class

Runs a set of default tests for a ModGameMode

```csharp
public abstract class ModGameModeTest<T> : BTD_Mod_Helper.Api.Testing.ModGameModeTest
    where T : BTD_Mod_Helper.Api.Scenarios.ModGameMode
```
#### Type parameters

<a name='BTD_Mod_Helper.Api.Testing.ModGameModeTest_T_.T'></a>
